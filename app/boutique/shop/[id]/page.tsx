    ...
    <>
      ...
      <div style={{ background: '#0a0f1a', minHeight: '100vh', color: '#e2e8f0' }}>
        ...
        <div className="sp-wrap">
          ...
          {/* Retour */}
          <Link href="/boutique/mes-boutiques" style={{ fontSize: 13, color: 'rgba(255,255,255,0.4)', textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: 6, marginBottom: 20 }}>
