...
const CATEGORIES = [
  ...
  { value: 'alimentaire', label: ' Alimentaire' }, { value: 'beaute', label: ' Beauté' },
  { value: 'maison', label: ' Maison' }, { value: 'service', label: ' Service' },
    ...
    <div style={{ background: '#0a0f1a', minHeight: '100vh' }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            backgroundImage: "url('https://images.unsplash.com/photo-1607082348824-0a96f2a4b9da?w=1400&q=80&auto=format&fit=crop')",
          ...
          <div style={{
            ...
            background: 'linear-gradient(135deg, rgba(10,15,26,0.3) 0%, rgba(30,15,5,0.15) 50%, rgba(10,15,26,0.35) 100%)',
          }} />
          {/* Fondu bas */}
          <div style={{
          ...
          {/* Contenu */}
          <div style={{ position: 'relative', zIndex: 3, maxWidth: 640, margin: '0 auto' }}>
            <div style={{
            ...
            <div style={{ background: '#111827', border: '0.5px solid rgba(255,255,255,0.08)', borderRadius: 16, padding: 24 }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
                {[
                  ...
                  { value: 'service', label: ' Service', desc: 'Prestation, formation, conseil...' },
                ].map(t => (
