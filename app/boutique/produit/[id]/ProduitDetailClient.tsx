                    ...
                    {product.delivery_available && (
                      <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                        ...
                        <div>
                          ...
                          <p style={{ fontSize: 11, color: 'rgba(255,255,255,0.35)' }}>{product.delivery_price > 0 ? `+${formatPrice(product.delivery_price)}` : 'Gratuite'}</p>
                        </div>
                      </div>
                    )}
              ...
              {!isService && !isOutOfStock && (
                <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 20 }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', background: '#111827', borderRadius: 10, border: '0.5px solid rgba(255,255,255,0.1)', overflow: 'hidden' }}>
                    ...
                    <button onClick={() => setQuantity(q => product.stock > 0 ? Math.min(product.stock, q + 1) : q + 1)} style={{ width: 36, height: 36, background: 'none', border: 'none', color: '#fff', fontSize: 18, cursor: 'pointer' }}>+</button>
                  </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                ...
                {(shop?.whatsapp || shop?.phone) && (
                  <a
                    ...
                    style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, padding: '14px', background: 'rgba(37,211,102,0.1)', border: '0.5px solid rgba(37,211,102,0.25)', borderRadius: 12, color: '#25D366', fontSize: 14, fontWeight: 600, textDecoration: 'none' }}
                  >
