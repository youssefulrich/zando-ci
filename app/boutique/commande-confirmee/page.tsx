...
function ConfirmationContent() {
  ...
  const shopName = decodeURIComponent(searchParams.get('shop') ?? 'le vendeur')
      ...
      <div style={{ maxWidth: 480, margin: '0 auto', padding: '60px 20px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <p style={{ fontSize: 14, color: 'rgba(255,255,255,0.45)', lineHeight: 1.7 }}>
            Votre commande a été enregistrée. Contactez maintenant {shopName} pour finaliser et organiser la livraison.
          </p>
        </div>
        ...
        {ref && (
          <div style={{
            ...
            <p style={{ fontSize: 11, color: 'rgba(255,255,255,0.3)', textTransform: 'uppercase', letterSpacing: 1, marginBottom: 4 }}>Référence commande</p>
        ...
        <div style={{
          ...
          {waUrl ? (
            ...
            <div style={{ padding: '14px', borderRadius: 12, background: 'rgba(251,191,36,0.08)', border: '0.5px solid rgba(251,191,36,0.2)', textAlign: 'center' }}>
              <p style={{ fontSize: 13, color: '#fbbf24' }}>⚠️ Le vendeur vous contactera sous peu</p>
            </div>
          )}
        </div>
        ...
        <div style={{
          ...
          <p style={{ fontSize: 12, color: 'rgba(255,255,255,0.5)', lineHeight: 1.7 }}>
            💡 Le message WhatsApp contient votre référence commande et vos coordonnées. Le paiement et la livraison se gèrent directement avec le vendeur.
          </p>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
          ...
          <Link href="/dashboard/mes-commandes" style={{
