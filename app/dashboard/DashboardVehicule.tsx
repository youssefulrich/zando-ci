  ...
  return (
    <>
      <style>{`
        ...
        .dv-booking-row { display: flex; justify-content: space-between; align-items: center; padding: 12px 0; }
        ...
        @media (max-width: 767px) {
          ...
          .dv-booking-row { flex-direction: column; align-items: flex-start; gap: 6px; }
              ...
              {bookings.length > 0 ? (
                <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                  {bookings.slice(0, 8).map((b, i) => (
                    <div key={b.id} className="dv-booking-row" style={{ borderBottom: i < 7 ? '0.5px solid rgba(255,255,255,0.05)' : 'none' }}>
                      <div>
