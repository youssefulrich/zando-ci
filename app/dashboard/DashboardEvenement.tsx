    ...
    <>
      <style>{`
        ...
        @media (max-width: 767px) {
          ...
          .de-revbar { flex-direction: column; gap: 16px; align-items: flex-start; }
          ...
          .de-item-actions { flex-direction: row !important; flex-wrap: wrap; gap: 6px !important; }
        ...
        <div className="de-wrap">
          ...
          <div className="de-header">
            <div>
              ...
              <h1 className="de-title" style={{ fontSize: 32, fontWeight: 800, color: '#fff', letterSpacing: -1, marginBottom: 6 }}>Bonjour, {profile.full_name.split(' ')[0]}</h1>
          ...
          <div className="de-stats">
            {[
              ...
              <div key={i} style={{ ...card, padding: 24, background: stat.highlight ? 'rgba(34,211,165,0.06)' : '#111827', border: stat.highlight ? '0.5px solid rgba(34,211,165,0.2)' : '0.5px solid rgba(255,255,255,0.08)' }}>
            ...
            <div style={{ ...card, padding: 24 }}>
              ...
              {events.length > 0 ? (
                    ...
                    return (
                      <div key={e.id} style={{ background: 'rgba(255,255,255,0.03)', border: '0.5px solid rgba(255,255,255,0.06)', borderRadius: 12, padding: 14 }}>
                        <div style={{ display: 'flex', gap: 12, alignItems: 'flex-start' }}>
                          ...
                          <div className="de-item-actions" style={{ display: 'flex', flexDirection: 'column', gap: 4, flexShrink: 0 }}>
                            <Link href={`/events/${e.id}`} style={{ fontSize: 11, color: accent, padding: '4px 10px', borderRadius: 8, border: `0.5px solid ${accentBorder}`, background: accentBg, textDecoration: 'none', textAlign: 'center' }}>Voir</Link>
                ...
                <div style={{ textAlign: 'center', padding: '40px 20px' }}>
                  ...
                  <Link href="/publier/evenement" style={{ fontSize: 13, color: accent, textDecoration: 'none', padding: '9px 18px', borderRadius: 10, border: `0.5px solid ${accentBorder}`, background: accentBg }}>Créer mon premier événement</Link>
                </div>
              )}
            </div>
