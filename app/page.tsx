...
export default function HomePage() {
  ...
  return (
    <>
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;1,300&family=Space+Grotesk:wght@300;400;500;600;700&display=swap');
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .svc-name { font-family: 'Space Grotesk', sans-serif; font-size: 18px; font-weight: 700; color: #fff; margin-bottom: 14px; line-height: 1.2; }
        .svc-link {
        ...
        .boutique-title { font-family: 'Space Grotesk', sans-serif; font-size: 20px; font-weight: 800; color: #fff; letter-spacing: -1px; margin-bottom: 4px; }
        ...
        .pay-title { font-family: 'Space Grotesk', sans-serif; font-size: clamp(24px, 3vw, 36px); font-weight: 800; color: #fff; letter-spacing: -1.5px; margin: 12px 0 16px; line-height: 1.1; }
        ...
        .cta-title {
          ...
          color: #fff; letter-spacing: -2px; margin-bottom: 16px; line-height: 1.05;
